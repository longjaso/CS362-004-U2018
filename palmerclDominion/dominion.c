...
/*
   Beginning of 5 card refactor:
 * Note: Refactors include pointers to the original values to mimic
   behavior where the parent function has access directly to variables declared
   in that funciton

   Cards to be changed:
   -smithy
    -Needs: int *i, struct gameState *state, int currentPlayer, int handPos,
   -adventurer
    -Needs: int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int temphand, int *z
   -village
    -Needs: struct gameState *state, int currentPlayer, int handPos
   -great hall
    -Needs: struct gameState *state, int currentPlayer, int handPos
   -embargo
    -Needs: struct gameState *state, int choice1, int handPos, int currentPlayer
 */
